...
#$REPO_DIR"/scripts/download_scripts/download_NSIDC_0079.sh" & # Fast
...
# Model downloads
##FIXPERMNATIVE##python $REPO_DIR"/scripts/download_scripts/Download_YOPP_ECMWF.py"  # Slow (30 mins)
...
# Upload to GCP
#### FIX LATER #####/home/disk/sipn/nicway/data/obs/zarr/update_obs.sh
